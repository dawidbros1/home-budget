...
button.addEventListener('click', function () {
    sendListShoppingList();
})

function checkEditListShoppingList() {
    ...
    for (var i = 0; i < date.length; i++) {
        (function (i) {
            ...
            deleteStatus[i].addEventListener('change', function () {
                edited[i].value = 1;
            }, false);
            ...
            discount[i].addEventListener('change', function () {
                edited[i].value = 1;
            }, false);

            product_id[i].addEventListener('change', function () {
                edited[i].value = 1;
            }, false);
        })(i);
    }
